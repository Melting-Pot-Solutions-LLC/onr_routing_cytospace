	'#n-0-3': '#n-0-3,#n-0-2,#n-0-1,#n-0-0', 
	'#n-5-6': '#n-5-6,#n-5-5,#n-5-4,#n-5-3,#n-5-2,#n-5-1,#n-5-0,#n-0-0', 
	'#n-2-3': '#n-2-3,#n-2-2,#n-2-1,#n-2-0,#n-1-0,#n-0-0', 
	'#n-4-5': '#n-4-5,#n-4-4,#n-4-3,#n-5-3,#n-5-2,#n-0-2,#n-0-1,#n-0-0', 
	'#n-2-7': '#n-2-7,#n-2-8,#n-2-9,#n-1-9,#n-0-9,#n-0-10,#n-0-11,#n-0-0', 
	'#n-0-2': '#n-0-2,#n-0-1,#n-0-0', 
	'#n-3-10': '#n-3-10,#n-4-10,#n-5-10,#n-5-11,#n-5-0,#n-0-0', 
	'#n-4-10': '#n-4-10,#n-5-10,#n-0-10,#n-0-11,#n-0-0', 
	'#n-2-10': '#n-2-10,#n-2-11,#n-1-11,#n-1-0,#n-0-0', 
	'#n-5-5': '#n-5-5,#n-5-4,#n-0-4,#n-0-3,#n-0-2,#n-0-1,#n-0-0', 
	'#n-2-11': '#n-2-11,#n-1-11,#n-1-0,#n-0-0', 
	'#n-0-6': '#n-0-6,#n-0-5,#n-0-4,#n-0-3,#n-0-2,#n-0-1,#n-0-0'}
                ...
                if (j != ROWS - 1) { // if the element is not at the last row
                    data.push({
                        "data": {
                            ...
                            "packets_currently_processing": [],
                            "packets_currently_processing_counters": [],
...
function simulate_routing_table(routing_table, clock_jitter, routing_table_number)
{
...
function simulate_routing_table_based_only_on_cycles(routing_table_json, number_of_total_cycles, number_of_cycles_per_period, routing_table_number) {
    // console.log("SIMULATING the following routing table");
    // console.log(routing_table_json);
    final_string_output = "";
    ...
    // for (var preriod = 0; preriod < number_of_periods; preriod++) {
        ...
        for (var cycle = 0; cycle < number_of_total_cycles; cycle++) {
                ...
                var next_node = (routing_table_json[origin])[packets[i].position_in_the_path + 1];
                    ...
                    switch (packets[i].status) {
                        case "inside_a_node":
                            ...
                            // not sure what the link is called
                            var edge_id_1 = "#e-" + 
                            extract_i_j_from_id(current_node)[0] + "-" + 
                            extract_i_j_from_id(current_node)[1] + "--" + 
                            extract_i_j_from_id(next_node)[0] + "-" + 
                            extract_i_j_from_id(next_node)[1];
                            var edge_id_2 = "#e-" + extract_i_j_from_id(next_node)[0] + "-" + extract_i_j_from_id(next_node)[1] + "--" + extract_i_j_from_id(current_node)[0] + "-" + extract_i_j_from_id(current_node)[1];
                            // now we found the exact name of the link
                            // add the packet to the packets_about_to_be_processed array
                            if (cy.$(edge_id_1).inside()) {
            ...
            if (cycle%8 != 0) {
            	// console.log("\nCYCLE #" + cycle);
                cy.edges().forEach(function(link) {
     //            	if(cycle == 198 && link.data('id') == "e-0-2--0-3")
     //            	{
     //            		console.log("30 more cycle");
     //            	}

					// if(cycle == 207 && link.data('id') == "e-0-2--0-3")
     //            	{
     //            		console.log("30 more cycle");
     //            	}
                    ...
                    // console.log("processing link " + link.data('id'));
                    var packets_currently_processing = link.data('packets_currently_processing');
                    var packets_about_to_be_processed = link.data('packets_about_to_be_processed');
                    var packets_currently_processing_counters = link.data('packets_currently_processing_counters');
                    ...
                    // deals with packets being processed
                    for(var i = 0; i < packets_currently_processing.length; i++)
                    {
                    	// decrease the counters for packets being processed
                    	if(packets_currently_processing_counters[i] > 0)
                    	{
                    		packets_currently_processing_counters[i]--;
                    	}



                    	// releas the packet to the node
                    	if (packets_currently_processing_counters[i] == 0)
                    	{
                    		// releasing the packet to the next node
	                        // console.log("packet from " + packets[packets_currently_processing[i]].origin + " came to node" + packets[packets_currently_processing[i]].going_to);
	                        packets[packets_currently_processing[i]].status = "inside_a_node";
	                        packets[packets_currently_processing[i]].link_packet_is_in = "";
	                        packets[packets_currently_processing[i]].current_node = packets[packets_currently_processing[i]].going_to;
	                        packets[packets_currently_processing[i]].going_from = "";
	                        ...
	                        // remove that element from the arrays
	                        packets_currently_processing.splice(i, 1);
	                        packets_currently_processing_counters.splice(i, 1);
                    	}
                    ...
                    // deals with packets about to be processed
                    if (packets_about_to_be_processed.length == 0) {} else if (packets_about_to_be_processed.length == 1) {
                        if(number_of_flits_left_to_send_in_a_packet == 0)
                        {

                        	// console.log("packet from " + packets[packets_about_to_be_processed[0]].origin + " starts being processed in " + link.data('id'));
                            ...
                            packets_currently_processing_counters.push(o);
                            packets_about_to_be_processed.shift();
                            number_of_flits_left_to_send_in_a_packet = NUMMBER_OF_FLITS_PER_PACKET;
                        ...
                        else
                        {
                            ...
                            // {
                            // 	console.log("Cycle - " + cycle);
                            // 	console.log("is waiting for #" + packet_currently_processing + " from " + packets[packet_currently_processing].origin);
                        ...
                        if(number_of_flits_left_to_send_in_a_packet == 0)
                        {
                            ...
                            // console.log("packet from " + packets[r].origin + " starts being processed in " + link.data('id'));
                            number_of_flits_left_to_send_in_a_packet = NUMMBER_OF_FLITS_PER_PACKET;
                            ...
                            // number_of_flits_left_to_send_in_a_packet = NUMMBER_OF_FLITS_PER_PACKET+1;
                             // console.log("packet from " + packets[packet_currently_processing].origin + " starts being processed in " + link.data('id'));
                        }
                        else
                        {
                            packets_about_to_be_processed.forEach(
                              ...
                              //       if (packets[el].path.length == 2)
		                            ...
		                            // 	console.log("Cycle - " + cycle);
		                            // 	console.log(packets_about_to_be_processed);
                            		// 	console.log("packet #" + el + " from " + packets[el].origin);
                            		// 	console.log("is waiting for #" + packet_currently_processing + " from " + packets[packet_currently_processing].origin);
		                            // }
                                }
                            );
                    ...
                    link.json({ "data": { "packets_currently_processing": packets_currently_processing } });
                    link.json({ "data": { "packets_about_to_be_processed": packets_about_to_be_processed } });
                    link.json({ "data": { "packets_currently_processing_counters": packets_currently_processing_counters } });
...
//there should be more jitter than clock jitter, which changes based on the routing table, 
// 100 periods
// tachyon.cse.sc.edu 
// higgs.cse.sc.edu 
// remote desktop   

// for PROPOSAL: routing tables matters, 100 balanced, 100 unbalanced
// fix bug
// comapre huge amount of routing tables
// for different clock jitter
// differet packet sizes
// label the links with # of stalls 
